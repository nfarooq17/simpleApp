...
export default function Instructions() {
  ...
  async function countEx() {
    let i = 0 
    let y = 0
    const exRef = await firebase.firestore().collection('inst').get()
...
<Link style={{cursor:'pointer' ,textDecoration:"none", marginLeft:40, padding:10, borderRadius:5, backgroundColor:"#3F51B5", color:'white',  }} href = '/NewInstruction'>New Instruction</Link>
</Grid>
      ...
      {votelist && <Grid item xs={12}>
              <Paper className={classes.paper}>
                <InstrcutionDetailTable data={votelist}  />
              </Paper>
            </Grid>}
