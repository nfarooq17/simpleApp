...
export default function AlertDetails({match}) {
  ...
  async function loadData() {
    ...
    const postRef = await firebase.firestore().collection("Alert").doc(String(match.params.id).toString()).get()
    ...
    <div className={classes.root}>
      ...
      <main className={classes.content}>
        ...
        <Container maxWidth="lg" className={classes.container}>
           ...
           { listings && <AlertDetailCard id ={match.params.id} data={listings}/>}
