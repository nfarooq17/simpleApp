...
export default function AddUser() {
  ...
  async function Register(value){
    const userRef = await firebase.firestore().collection('user').where('badge','==',value.badge).get()
...
//     const userRef = await firebase.firestore().collection('user').where('badge','==',values.badge).get()
//     values.admin = authContext.user.name
//     alert(userRef.empty)
//     alert(values)

//     if(userRef.empty){
//       await firebase.firestore().collection('user').add(values)
//       alert ('Done!')
//       setFile(null);
//     }
//     else{
...
//         }}
//         onSubmit={(values) => {handleUpload(values)}}>
//        {({ submitForm, isSubmitting }) => ( <Container component="main" maxWidth="xs">
//       <CssBaseline />
//       <div className={classes.paper}>
//       <input
//               accept="image/*"
