...
export default function NewsDetails({match}) {
  ...
  async function loadData() {
    ...
    const postRef = await firebase.firestore().collection("posts").doc(String(match.params.id).toString()).get()
    ...
    <div className={classes.root}>
      ...
      <main className={classes.content}>
        ...
        <Container maxWidth="lg" className={classes.container}>
           ...
           { listings && <NewsResultCard id ={match.params.id} data={listings}/>}
