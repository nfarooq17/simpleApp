...
export default function News() {
  ...
  const fixedHeightPaper = clsx(classes.paper, classes.fixedHeight);
      ...
      async function countVote(){
        console.log("yr b ")
        const voteRef = await firebase.firestore().collection('posts').get()
    ...
    <div className={classes.root}>
      ...
      <main className={classes.content}>
        ...
        <Container maxWidth="lg" className={classes.container}>
            ...
            <Link style={{cursor:'pointer' ,textDecoration:"none", marginLeft:40, padding:10, borderRadius:5, backgroundColor:"#3F51B5", color:'white',  }} href = '/NewNews'>New News</Link>
