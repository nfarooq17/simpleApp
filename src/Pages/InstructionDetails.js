...
import NewsResultCard from "../components/NewsResultCad";
import VoteDetailCard from "../components/config/VoteDetailCard";
import InstructionDetailCard from "../components/InstructionDetailCard";
...
export default function InstructionDetails({match}) {
  ...
  async function loadData() {
    ...
    console.log(match.params.I_d)
    const postRef = await firebase.firestore().collection("inst").doc(String(match.params.id).toString()).get()
    setListings(postRef.data())
    ...
    <div className={classes.root}>
      ...
      <main className={classes.content}>
        ...
        <Container maxWidth="lg" className={classes.container}>
           ...
           { listings && <InstructionDetailCard id ={match.params.id} data={listings}/>}
