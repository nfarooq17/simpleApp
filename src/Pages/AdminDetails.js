...
export default function AdminDetails({match}) {
  ...
  async function loadData() {
    ...
    const postRef = await firebase.firestore().collection("admins").doc(String(match.params.id).toString()).get()
    ...
    <div className={classes.root}>
      ...
      <main className={classes.content}>
        ...
        <Container maxWidth="lg" className={classes.container}>
           ...
           { listings && <AdDetailCard id ={match.params.id} data={listings}/>}
