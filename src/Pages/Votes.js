...
export default function Instructions() {
  ...
  async function countEx() {
    let i = 0 
    let y = 0
    const exRef = await firebase.firestore().collection('votes').get()
    ...
    <div className={classes.root}>
      ...
      <main className={classes.content}>
        ...
        <Container maxWidth="lg" className={classes.container}>
            ...
            <Grid item xs={1} md={1} lg={3} >
                ...
                <Link style={{cursor:'pointer' ,textDecoration:"none", marginLeft:40, padding:10, borderRadius:5, backgroundColor:"#3F51B5", color:'white',  }} href = '/NewVotes'>New Vote</Link>
            </Grid>
      ...
      {votelist && <Grid item xs={12}>
              <Paper className={classes.paper}>
                <VoteDetailsTable data={votelist}  />
              </Paper>
            </Grid>}
